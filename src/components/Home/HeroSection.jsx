      ...
      >
        {heroSlides.map((slide) => (
          <SwiperSlide key={slide.id} className="text-text-color bg-background">
            <section
              className="relative xl:bg-contain bg-no-repeat 2xl:bg-center sm:bg-[length:720px] sm:bg-right-bottom bg-left-top h-full container mx-auto sm:px-4 px-0 sm:w-11/12 sm:my-10"
            ...
            >
              ...
              <div className="relative max-w-[556px] xl:pt-[275px] sm:pt-16 pt-[40%] sm:text-left text-center z-10 sm:w-full sm:mx-0 mx-auto px-4">
                <h1 className="sm:text-[54px] text-[40px] font-bold sm:leading-[64px] leading-10">
                  {slide.title}
                </h1>
